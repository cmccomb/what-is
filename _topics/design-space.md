...
read_time: 6 minutes
updated: 2026-07-22
detail_title: Space is what you make it
related:
  - optimization
  - generative-design
...
A search trajectory is also an object worth studying. In our work with high-dimensional cyber-physical-system design agents, we visualize where an agent travels, revisits, or refuses to go rather than reporting only its final design. Two methods can land on equally good artifacts through radically different exploration behavior—and those differences matter for cost, robustness, and collaboration.
...
- **[The Sciences of the Artificial](https://mitpress.mit.edu/9780262537537/the-sciences-of-the-artificial/)** — Herbert A. Simon (3rd ed., 1996). Establishes design as a search for satisfactory artifacts within an environment of alternatives and constraints.
- **[Reinforcement Learning for Efficient Design Space Exploration With Variable Fidelity Analysis Models](https://doi.org/10.1115/1.4056297)** — Akash Agrawal and Christopher McComb (2023), <em>Journal of Computing and Information Science in Engineering</em>. Shows how representation, simulation cost, and search policy interact in realistic engineering spaces.
- **[DS-Viz: A Method for Visualising Design Spaces](https://doi.org/10.1017/pds.2024.106)** — Esdras Paravizo and Nathan Crilly (2024), <em>Proceedings of the Design Society</em>. Connects the spatial metaphor to empirical analysis of designer behavior.
...
- **[Comparing Strategies for Visualizing the High-Dimensional Exploration Behavior of CPS Design Agents](https://doi.org/10.1109/DESTION56136.2022.00017)** — **From our group.** treats exploration trajectories as objects of analysis rather than reporting only final designs.
{: .reading-list }
