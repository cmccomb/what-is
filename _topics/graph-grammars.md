...
<ul class="reading-list">
  ...
  <li><strong><a href="https://doi.org/10.1115/1.4005592">Computational Synthesis of Product Architectures Based on Object-Oriented Graph Grammars</a></strong> — Bergen Helms and Kristina Shea (2012), <em>Journal of Mechanical Design</em>.<p>The anchor for this guide. It uses object-oriented graph grammars to capture engineering knowledge and synthesize product architectures across function, behavior, and structure.</p></li>
  <li><strong><a href="https://doi.org/10.1017/S0890060414000195">Systematic Rule Analysis of Generative Design Grammars</a></strong> — Corinna Königseder and Kristina Shea (2014), <em>AI EDAM</em>.<p>Treats grammar development as an engineering task and shows how rule formulation affects generation, evaluation, and search.</p></li>
  <li><strong><a href="https://doi.org/10.1017/dsj.2016.5">Improving Design Grammar Development and Application Through Network-Based Analysis of Transition Graphs</a></strong> — Corinna Königseder, Tino Stanković, and Kristina Shea (2016), <em>Design Science</em>.<p>Represents unique designs as states and rule applications as transitions so grammar developers can expose loops, duplicate paths, vague rules, and other structural problems.</p></li>
  ...
  <li><strong><a href="https://doi.org/10.1017/S089006042200018X">Graph Transformation in Engineering Design: An Overview of the Last Decade</a></strong> — Christopher Voss, Frank Petzold, and Stephan Rudolph (2023), <em>AI EDAM</em>.<p>An open review of terminology, application domains, implementations, and research gaps in engineering design.</p></li>
</ul>
