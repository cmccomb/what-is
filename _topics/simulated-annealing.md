...
The algorithm need not search alone. Our heterogeneous simulated-annealing teams give different agents different search behaviors and let them exchange solutions selectively, translating characteristics of human design teams into a multi-agent optimizer. Heterogeneity is useful when it sustains genuinely different searches—not when it merely runs the same annealer several times.

### Why getting worse helps
...
- **[Equation of State Calculations by Fast Computing Machines](https://doi.org/10.1063/1.1699114)** — Nicholas Metropolis and colleagues (1953), <em>The Journal of Chemical Physics</em>. Introduces the acceptance mechanism that later became the computational core of simulated annealing.
- **[Optimization by Simulated Annealing](https://doi.org/10.1126/science.220.4598.671)** — Scott Kirkpatrick, C. Daniel Gelatt Jr., and Mario P. Vecchi (1983), <em>Science</em>. Establishes the statistical-mechanics analogy and demonstrates it on difficult combinatorial optimization problems.
- **[Thermodynamical Approach to the Traveling Salesman Problem: An Efficient Simulation Algorithm](https://doi.org/10.1007/BF00940812)** — Vladimír Černý (1985), <em>Journal of Optimization Theory and Applications</em>. An independent foundational development focused on the traveling-salesperson problem.
- **[Simulated Annealing and Boltzmann Machines](https://doi.org/10.1007/978-94-015-7744-1)** — Emile Aarts and Jan Korst (1989), Wiley. A systematic treatment of theory, implementation choices, and applications.
...
- **[Drawing Inspiration from Human Design Teams for Better Search and Optimization](https://doi.org/10.1115/1.4032810)** — **From our group.** introduces heterogeneous simulated annealing teams (HSAT), which translate observed characteristics of human design teams into a multi-agent search algorithm.
{: .reading-list }
